...
const Orders = () => {
  ...
  const fetchdata = async () => {
    const data = await fetch("http://localhost:5000/api/orders/cancelOrders", options);
  ...
  return (
    <div className="container my-4">
      <h2 className="mb-4 text-primary border-bottom border-primary pb-2">Cancel Orders</h2>
      {orders.length === 0 ? (
